	...
	<div class="wrapper">
		...
		<form action="" method="POST" enctype="multipart/form-data">
			<table class="tlb-30">
						...
						<select name="category">
							...
							<?php 
								...
								if($count > 0) {
									...
									?><option value="0">Category Not Found</option><?php
				...
				<tr>
					<td colspan="2">
						<input type="submit" name="submit" value="Add" class="btn-create">
					</td>
				</tr>
		...
		<?php
			...
			if(isset($_POST['submit'])) {
				...
				$sql2 = "INSERT INTO food_type SET
					title = '$title',
				...
				if($res2 == true) {
					...
					$_SESSION['add'] = "<div class='error'>Failed to add food, something went wrong!</div>";
				}
